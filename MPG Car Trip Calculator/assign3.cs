using System;                       //needed for String.Format
...
namespace assign3
{
    ...
    {
        //Hold Instance of 'Vehicle' object - MUST BE OUTSIDE of any button/event to Apply to the whole 'assign3' class
        ...
        private void btnDrive_Click(object sender, EventArgs e)
        {
            ...
            input.ShowDialog();                         //Opens up the 2nd Form - Miles User Will Drive
        ...
        {
            //When user clicks 'Fill' - Gas Tank Fills Up to Full tank (12)
            m_myVehicle.FillGas();
            //Call properties
            txtGas.Text = m_myVehicle.GasRemaining.ToString();
        }
